...
{	
	ChipmunkConstraint *obj = constraint->data;
...
{
	[(ChipmunkConstraint *)constraint->data preSolve:(ChipmunkSpace *)space->data];
}

static void
PostSolve(cpConstraint *constraint, cpSpace *space)
{
	[(ChipmunkConstraint *)constraint->data postSolve:(ChipmunkSpace *)space->data];
}
